...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, a as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, b as RequestStatusDoneNoReplyErrorCode, d as RejectError, e as CertifiedRejectErrorCode, f as UNREACHABLE_ERROR, I as InputError, g as InvalidReadStateRequestErrorCode, h as ReadRequestType, i as Principal, k as IDL, m as MissingCanisterIdErrorCode, H as HttpAgent, n as encode, Q as QueryResponseStatus, o as UncertifiedRejectErrorCode, p as isV3ResponseBody, q as isV2ResponseBody, r as UncertifiedRejectUpdateErrorCode, s as UnexpectedErrorCode, t as decode, v as Subscribable, w as pendingThenable, x as resolveEnabled, y as shallowEqualObjects, z as resolveStaleTime, A as noop, D as environmentManager, F as isValidTimeout, G as timeUntilStale, J as timeoutManager, K as focusManager, L as fetchState, N as replaceData, O as notifyManager, V as hashKey, W as getDefaultState, X as reactExports, Y as shouldThrowError, Z as useQueryClient, _ as useInternetIdentity, $ as createActorWithConfig, c as createLucideIcon, j as jsxRuntimeExports, a0 as Slot$1, a1 as cn, a2 as cva, a3 as React, a4 as composeRefs$1, a5 as reactDomExports, a6 as useComposedRefs$1, a7 as ReactDOM, a8 as Record, a9 as Variant, aa as Service, ab as Func, ac as Vec, ad as Int, ae as Text, af as Bool, ag as Principal$1, B as Button, ah as ue } from "./index-unuqxXhD.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, a as usePresence$1, b as useIsomorphicLayoutEffect$1, L as LayoutGroupContext, m as motion } from "./proxy-BvLHhFqF.js";
...
const CreateTaskResult = Variant({ "ok": Task, "err": Text });
const DeleteTaskResult = Variant({
  "ok": Bool,
  "err": Text
});
const ToggleTaskResult = Variant({ "ok": Task, "err": Text });
const UpdateTaskResult = Variant({ "ok": Task, "err": Text });
Service({
  "createTask": Func([Text, Text], [CreateTaskResult], []),
  "deleteTask": Func([TaskId], [DeleteTaskResult], []),
  "getTasks": Func([], [Vec(Task)], ["query"]),
  "toggleTask": Func([TaskId], [ToggleTaskResult], []),
  "updateTask": Func([TaskId, Text, Text], [UpdateTaskResult], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const TaskId2 = IDL2.Text;
  ...
  const CreateTaskResult2 = IDL2.Variant({ "ok": Task2, "err": IDL2.Text });
  const DeleteTaskResult2 = IDL2.Variant({ "ok": IDL2.Bool, "err": IDL2.Text });
  const ToggleTaskResult2 = IDL2.Variant({ "ok": Task2, "err": IDL2.Text });
  const UpdateTaskResult2 = IDL2.Variant({ "ok": Task2, "err": IDL2.Text });
  return IDL2.Service({
    "createTask": IDL2.Func([IDL2.Text, IDL2.Text], [CreateTaskResult2], []),
    "deleteTask": IDL2.Func([TaskId2], [DeleteTaskResult2], []),
    "getTasks": IDL2.Func([], [IDL2.Vec(Task2)], ["query"]),
    "toggleTask": IDL2.Func([TaskId2], [ToggleTaskResult2], []),
    "updateTask": IDL2.Func(
      [TaskId2, IDL2.Text, IDL2.Text],
      [UpdateTaskResult2],
      []
    )
  });
...
class Backend {
  ...
  async updateTask(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
function from_candid_CreateTaskResult_n1(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n2(_uploadFile, _downloadFile, value);
}
function from_candid_DeleteTaskResult_n3(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n4(_uploadFile, _downloadFile, value);
}
function from_candid_ToggleTaskResult_n5(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n2(_uploadFile, _downloadFile, value);
}
function from_candid_UpdateTaskResult_n6(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n2(_uploadFile, _downloadFile, value);
}
...
function useToggleTask() {
  ...
  return useMutation({
    ...
    onError: (_err, _id, ctx) => {
      if (ctx == null ? void 0 : ctx.previous) {
...
function TaskSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg p-4 flex items-start gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-5 rounded mt-0.5 shrink-0" }),
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: `mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded border transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${task.completed ? "bg-primary border-primary" : "border-border hover:border-primary"}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: `text-sm font-medium leading-snug break-words ${task.completed ? "task-completed" : "text-foreground"}`,
              children: task.title
            }
          ),
          task.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground line-clamp-2 break-words leading-relaxed", children: task.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1.5 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground/60", children: dateLabel }),
...
function QuickAddForm({ onOpen }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", "data-ocid": "quick-add-form", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        ref: inputRef,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: done === total && total > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-primary font-medium", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4" }),
            "All done! Great work."
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: done }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: " of " }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: active }),
            " active"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: done }),
    ...
    "div",
    {
      ...
      children: tabs.map(({ key, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `flex-1 rounded-md py-1.5 text-xs font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring flex items-center justify-center gap-1.5 ${filter === key ? "bg-card shadow-xs text-foreground border border-border" : "text-muted-foreground hover:text-foreground"}`,
          children: [
            label,
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `tabular-nums ${filter === key ? "text-primary font-semibold" : "text-muted-foreground/60"}`,
                children: counts[key]
              }
            )
          ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-widest mb-0.5", children: dayName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-semibold text-foreground tracking-tight", children: dateHeading })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "tasks-loading", children: ["s1", "s2", "s3"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(TaskSkeleton, {}, k)) }),
    !isLoading && allTasks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
        ...
        className: "space-y-3",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatsBar, { active: activeCnt, done: doneCnt, total: allTasks.length }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            FilterTabs,
            {
              filter,
    ...
    !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { mode: "popLayout", children: [
        filteredTasks.length === 0 && allTasks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            initial: { opacity: 0 },
            animate: { opacity: 1 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Delete task?" }) }),
